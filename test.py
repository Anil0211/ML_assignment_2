...
if __name__ == '__main__':
    ...
    filename = r'C:\Anil\UTD\Machine_Learning\Assignment\assignment2\homework2_programming_Spring_unmod\homework2_programming 2_unmod\checkpoints\yolo_final.checkpoint.pth'
