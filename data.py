...
class CrackerBox(data.Dataset):
    def __init__(self, image_set = 'train', data_path = r'C:\Anil\UTD\Machine_Learning\Assignment\assignment2\homework2_programming_Spring_unmod\homework2_programming 2_unmod\yolo\data'):
    ...
    def __getitem__(self, idx):
        ...
        gt_box_blob[:, grid_y, grid_x] = torch.tensor([cx_offset, cy_offset, w_norm, h_norm, 1.0], dtype=torch.float32)
